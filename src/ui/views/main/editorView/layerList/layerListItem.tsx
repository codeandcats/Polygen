    ...
    return (
      <li className={layerItemClassNames}>
        <ButtonGroup>
          ...
          <OverlayTrigger
            overlay={
              <Tooltip id='toggleLayerVisibilityTooltip'>{layer.isVisible ? 'Hide layer' : 'Show layer'}</Tooltip>
            }
            placement='top'
          >
            <Button
              variant={buttonStyle}
              className={classNames(mainStyles.iconButton, styles.layerVisibilityButton)}
          ...
          >
            ...
            <Dropdown.Item eventKey='5' disabled={!canRemoveLayer} onClick={() => this.props.onRemoveLayer(layer)}>
