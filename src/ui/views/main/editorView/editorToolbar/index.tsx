...
import {
	Button, ButtonGroup, ControlLabel, OverlayTrigger,
...
export class EditorToolbar extends React.Component<EditorToolbarProps, EditorToolbarState> {
	...
	public render() {
		return (
			<div>
				<ControlLabel className={ mainStyles.spaceRight }>Mode</ControlLabel>
				<ToggleButtonGroup
					name='mode'
					type='radio'
				...
				>
					<ToggleButton className='btn-sm' value={'preview'}>Preview</ToggleButton>
					<ToggleButton className='btn-sm' value={'edit'}>Edit</ToggleButton>
				</ToggleButtonGroup>
				{
					this.props.mode === 'preview' ?
					null :
					<div style={ { display: 'inline-block' } }>
						<ControlLabel className={ classNames(mainStyles.spaceLeft2x, mainStyles.spaceRight) }>Tools</ControlLabel>
						<ButtonGroup>
							{
