...
import { ArrayPoint } from '../models/arrayPoint';
...
export function getDistanceBetweenPoints(pointA: Point, pointB: Point): number {
  const distanceSquared = getDistanceBetweenPointsSquared(pointA, pointB);
...
export function pointToArrayPoint(point: Point): ArrayPoint {
